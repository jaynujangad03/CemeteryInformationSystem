			...
			<div class="col-sm-6">
				 <label>Location::</label> 
		              <select class="form-control " name="LOCATION" id="LOCATION" style="width: 100%;"> 
			            <option  >Roman Catholic Memorial Gardens</option> 
			            <option >Minglanilla Celestial Cemetery</option>
			          </select>  
			</div>
			<div class="col-sm-2">
				<label>Section::</label> 
...
<span id="printout">
	<div class="col-md-12">
	<div style="text-align: center;font-size: 16px;">Roman Catholic Memorial Gardens</div>
	<div style="text-align: center;font-size: 14px;">Minglanilla Celestial Cemetery</div>
