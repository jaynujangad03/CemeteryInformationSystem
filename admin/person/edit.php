                   ...
                   <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <select class="form-control input-sm" name="LOCATION" id="LOCATION">
                          ...
                          <option value="Roman Catholic Memorial Gardens" <?php echo ($p->LOCATION=='Roman Catholic Memorial Gardens') ? 'SELECTED' : '';?>>Roman Catholic Memorial Gardens</option>
                          <option value="Minglanilla Celestial Cemetery" <?php echo ($p->LOCATION=='Minglanilla Celestial Cemetery') ? 'SELECTED' : '';?>>Minglanilla Celestial Cemetery</option>
